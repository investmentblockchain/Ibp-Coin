...
# Stone-Coin Masternode Setup Guide (Ubuntu 16.04)
...
`wget -q https://raw.githubusercontent.com/Realbityoda/Ibp-Coin/master/ibp_install.sh`
***
...
***Step 1***
* Download and install the Ibp Coin wallet [here](https://github.com/investmentblockchain/IBP-Core/releases)
***

***Step 2***
* Send EXACLY 1,000 IBP to a receive address within your wallet.
***
